...
+======================+=============================+===================+=======================+
| exact_match          | Поиск по точному совпадению | r1 - ключ поиска  | r1 - значение, r2 -   |
|                      | в таблице данного блока M-A |                   | результат (1 - успех, |
|                      |                             |                   | 0 - неудача)          |
+----------------------+-----------------------------+-------------------+-----------------------+
| longest_prefix_match | Поиск по наибольшему        | r1 - ключ поиска  | r1 - значение, r2 -   |
|                      | совпадению префикса в       |                   | результат (1 - успех, |
|                      | таблице данного блока M-A   |                   | 0 - неудача)          |
+----------------------+-----------------------------+-------------------+-----------------------+
